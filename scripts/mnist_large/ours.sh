...
--eps_test_L2 1.0 --eps_end_L2 1.0 --joint --lambda_ratio_L2 0.00001 --max --lp --lbd 0.5 --gp --beta 0.8"
...
#     exit 1
# fi
# MODEL_PATH=/home/enyij2/SABR/models/mnist/use_shrinking_box_False/mnist__CNN7__bn_1_1__eps_0.3__lambda_0.6__lbd_0.5__beta_0.5__2024_09_24-13_41_38/mnist__CNN7__bn_1_1__eps_0.3__lambda_0.6__lbd_0.5__beta_0.5__2024_09_24-13_41_38.onnx
...
python abcrown.py --config exp_configs/my_test_l2_large.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l2_mnist_ours_large_0.8.txt
python abcrown.py --config exp_configs/my_test_l1_large.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l1_mnist_ours_large_0.8.txt
python abcrown.py --config exp_configs/my_test_linf_large.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_linf_mnist_ours_large_0.8.txt

# Step 5: calculate union accuracy
python cal_union.py --dataset mnist --file_path ours_large_0.8
