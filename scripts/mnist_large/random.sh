...
--eps_test_L2 1.5 --eps_end_L2 1.5 --joint --lambda_ratio_L2 0.00001 --random"
...
#     exit 1
# fi
# MODEL_PATH=/home/enyij2/SABR/models/sabr_models/mnist/mnist__CNN7__bn_1_1__eps_0.3__lambda_0.6__lbd_1.5__random/mnist__CNN7__bn_1_1__eps_0.3__lambda_0.6__lbd_1.5__2024_07_30-16_35_28.onnx
cd ~/alpha-beta-CROWN/complete_verifier/
conda activate alpha-beta-crown

# Step 4: Run the analysis script
# python $ANALYSIS_SCRIPT
python abcrown.py --config exp_configs/my_test_l2_large.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l2_mnist_random_large.txt
python abcrown.py --config exp_configs/my_test_l1_large.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l1_mnist_random_large.txt
python abcrown.py --config exp_configs/my_test_linf_large.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_linf_mnist_random_large.txt

# Step 5: calculate union accuracy
python cal_union.py --dataset mnist --file_path random_large
