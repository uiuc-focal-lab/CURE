...
--eps_test_L2 0.75 --eps_end_L2 0.75 --joint --lambda_ratio_L2 0.00001"
...
python abcrown.py --config exp_configs/my_test_l2_small.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l2_mnist_joint_small.txt
python abcrown.py --config exp_configs/my_test_l1_small.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l1_mnist_joint_small.txt
python abcrown.py --config exp_configs/my_test_linf_small.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_linf_mnist_joint_small.txt

# Step 5: calculate union accuracy
python cal_union.py --dataset mnist --file_path joint_small
