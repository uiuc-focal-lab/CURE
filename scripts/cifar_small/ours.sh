...
--eps_test_L2 0.25 --eps_end_L2 0.25 --joint --lambda_ratio_L2 0.00001 --max --lp --gp --reverse --lbd 2.0 --beta 0.8"
...
python abcrown.py --config exp_configs/my_test_l2_cifar_small.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l2_cifar_ours_small_0.8.txt
python abcrown.py --config exp_configs/my_test_l1_cifar_small.yaml --complete_verifier skip --onnx_path $MODEL_PATH > out_l1_cifar_ours_small_0.8.txt
python abcrown.py --config exp_configs/my_test_linf_cifar_small.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_linf_cifar_ours_small_0.8.txt

# Step 5: calculate union accuracy
python cal_union.py --dataset cifar --file_path ours_small_0.8
