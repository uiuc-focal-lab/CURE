...
python abcrown.py --config exp_configs/tinyimagenet_l2.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_l2_tiny_joint.txt
python abcrown.py --config exp_configs/tinyimagenet_l1.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_l1_tiny_joint.txt
python abcrown.py --config exp_configs/tinyimagenet_linf.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_linf_tiny_joint.txt
