...
--eps_test_L2 0.14117647058 --eps_end_L2 0.14117647058 --joint --lambda_ratio_L2 0.00001"
...
python abcrown.py --config exp_configs/tinyimagenet_l2_2.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_l2_tiny_joint.txt
python abcrown.py --config exp_configs/tinyimagenet_l1_2.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_l1_tiny_joint.txt
python abcrown.py --config exp_configs/tinyimagenet_linf_2.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_linf_tiny_joint.txt

# Step 5: calculate union accuracy
python cal_union.py --dataset tiny --file_path joint
