...
python abcrown.py --config exp_configs/tinyimagenet_l2_2.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_l2_tiny_max.txt
python abcrown.py --config exp_configs/tinyimagenet_l1_2.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_l1_tiny_max.txt
python abcrown.py --config exp_configs/tinyimagenet_linf_2.yaml --complete_verifier skip --share_alphas --onnx_path $MODEL_PATH > out_linf_tiny_max.txt
