...
### Training
All training scripts with different baselines and CURE framework can be found in `scripts` folder, which consists experiments on MNIST, CIFAR-10, and TinyImagenet. 
...
+ [https://github.com/eth-sri/SABR](https://github.com/eth-sri/SABR).
